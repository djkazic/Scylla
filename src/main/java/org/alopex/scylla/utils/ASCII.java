...
public class ASCII {
	...
	public static final String ayylmao = "                        .   *        .       .                \n" +
			"         *      -0-\n" +
			"            .                .  *       - )-\n" +
			"         .      *       o       .       * \n" +
			"   o                |\n" +
	...
	public static final String floppy = "   __________\n" +
			"     .'`   |     |`'.\n" +
			"     |     '-----'  |\n" +
			"     |              |\n" +
			"     |  .--------.  |\n" +
	...
	public static final String fatcat = "\n    /\\_____/\\\n" +
			"   /  o   o  \\\n" +
			"  ( ==  ^  == )\n" +
			"   )         (\n" +
			"  (           )\n" +
